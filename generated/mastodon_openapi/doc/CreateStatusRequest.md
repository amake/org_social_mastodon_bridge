# mastodon_openapi.model.CreateStatusRequest
...
**mediaIds** | **BuiltList&lt;String&gt;** | Include Attachment IDs to be attached as media. If provided, `status` becomes optional, and `poll` cannot be used. | 
