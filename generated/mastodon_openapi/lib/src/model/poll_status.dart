...
@BuiltValue()
abstract class PollStatus
    implements BaseStatus, Built<PollStatus, PollStatusBuilder> {
  ...
  factory PollStatus([void updates(PollStatusBuilder b)]) = _$PollStatus;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PollStatusBuilder b) => b..sensitive = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<PollStatus> get serializer => _$PollStatusSerializer();
}

class _$PollStatusSerializer implements PrimitiveSerializer<PollStatus> {
  @override
  final Iterable<Type> types = const [PollStatus, _$PollStatus];

  @override
  final String wireName = r'PollStatus';
  ...
  void _deserializeProperties(
    ...
    required PollStatusBuilder result,
  ...
  @override
  PollStatus deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PollStatusBuilder();
