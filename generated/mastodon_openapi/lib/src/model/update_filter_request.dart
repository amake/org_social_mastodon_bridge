...
///
/// Properties:
/// * [context] - Specify at least one of `home`, `notifications`, `public`, `thread`, `account`.
...
/// * [wholeWord] - Should the filter consider word boundaries? Defaults to false.
@BuiltValue()
abstract class UpdateFilterRequest
    implements Built<UpdateFilterRequest, UpdateFilterRequestBuilder> {
  ...
  factory UpdateFilterRequest([void updates(UpdateFilterRequestBuilder b)]) =
      _$UpdateFilterRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateFilterRequestBuilder b) => b
    ..irreversible = false
    ..wholeWord = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateFilterRequest> get serializer =>
      _$UpdateFilterRequestSerializer();
}

class _$UpdateFilterRequestSerializer
    implements PrimitiveSerializer<UpdateFilterRequest> {
  @override
  ...
  @override
  final String wireName = r'UpdateFilterRequest';
  ...
  void _deserializeProperties(
    ...
    required UpdateFilterRequestBuilder result,
  ...
  @override
  UpdateFilterRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateFilterRequestBuilder();
