...
@BuiltValue()
abstract class PreviewCard implements Built<PreviewCard, PreviewCardBuilder> {
  ...
  factory PreviewCard([void updates(PreviewCardBuilder b)]) = _$PreviewCard;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PreviewCardBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PreviewCard> get serializer => _$PreviewCardSerializer();
}

class _$PreviewCardSerializer implements PrimitiveSerializer<PreviewCard> {
  @override
  final Iterable<Type> types = const [PreviewCard, _$PreviewCard];

  @override
  final String wireName = r'PreviewCard';
  ...
  void _deserializeProperties(
    ...
    required PreviewCardBuilder result,
  ...
  @override
  PreviewCard deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PreviewCardBuilder();
