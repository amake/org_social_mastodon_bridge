...
/// * [role] - The complete role assigned to the currently authorized user, including permissions and highlighted status.
/// * [source_]
...
@BuiltValue()
abstract class CredentialAccount
    implements Built<CredentialAccount, CredentialAccountBuilder> {
  ...
  CredentialAccountSource get source_;
  ...
  factory CredentialAccount([void updates(CredentialAccountBuilder b)]) =
      _$CredentialAccount;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CredentialAccountBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CredentialAccount> get serializer =>
      _$CredentialAccountSerializer();
}

class _$CredentialAccountSerializer
    implements PrimitiveSerializer<CredentialAccount> {
  @override
  final Iterable<Type> types = const [CredentialAccount, _$CredentialAccount];

  @override
  final String wireName = r'CredentialAccount';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.source_,
      specifiedType: const FullType(CredentialAccountSource),
    );
  ...
  void _deserializeProperties(
    ...
    required CredentialAccountBuilder result,
  ...
  @override
  CredentialAccount deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CredentialAccountBuilder();
