...
class ScheduledStatusesApi {
  ...
  const ScheduledStatusesApi(this._dio, this._serializers);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ScheduledStatus),
            ) as ScheduledStatus;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ScheduledStatus>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View scheduled statuses Documentation](https://docs.joinmastodon.org/methods/scheduled_statuses/#get)
  Future<Response<BuiltList<ScheduledStatus>>> getScheduledStatuses({
    int? limit = 20,
    String? maxId,
    String? minId,
    String? sinceId,
    ...
    BuiltList<ScheduledStatus>? _responseData;
    ...
    return Response<BuiltList<ScheduledStatus>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ScheduledStatus>> updateScheduledStatus({
    ...
    try {
      const _type = FullType(UpdateScheduledStatusRequest);
      _bodyData = updateScheduledStatusRequest == null
          ? null
          : _serializers.serialize(updateScheduledStatusRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
