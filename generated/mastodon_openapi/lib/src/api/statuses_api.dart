...
class StatusesApi {
  ...
  const StatusesApi(this._dio, this._serializers);
  ...
  Future<Response<CreateStatus200Response>> createStatus({
    ...
    try {
      const _type = FullType(CreateStatusRequest);
      _bodyData =
          _serializers.serialize(createStatusRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CreateStatus200Response),
            ) as CreateStatus200Response;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<Status>> deleteStatus({
    ...
    final _queryParameters = <String, dynamic>{
      if (deleteMedia != null)
        r'delete_media': encodeQueryParameter(
            _serializers, deleteMedia, const FullType(bool)),
    };
  ...
  Future<Response<BuiltList<Account>>> getStatusFavouritedBy({
    required String id,
    int? limit = 40,
    String? maxId,
    String? sinceId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<StatusEdit>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View edit history of a status Documentation](https://docs.joinmastodon.org/methods/statuses/#history)
  Future<Response<BuiltList<StatusEdit>>> getStatusHistory({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<StatusEdit>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(StatusEdit)]),
            ) as BuiltList<StatusEdit>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<StatusEdit>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<Status>>> getStatusQuotes({
    required String id,
    int? limit = 20,
    String? maxId,
    String? sinceId,
  ...
  Future<Response<BuiltList<Account>>> getStatusRebloggedBy({
    required String id,
    int? limit = 40,
    String? maxId,
    String? sinceId,
  ...
  Future<Response<StatusSource>> getStatusSource({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(StatusSource),
            ) as StatusSource;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<Status>>> getStatuses({
    BuiltList<String>? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<Status>> postStatusReblog({
    ...
    try {
      const _type = FullType(PostStatusReblogRequest);
      _bodyData = postStatusReblogRequest == null
          ? null
          : _serializers.serialize(postStatusReblogRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<Translation>> postStatusTranslate({
    ...
    try {
      const _type = FullType(PostStatusTranslateRequest);
      _bodyData = postStatusTranslateRequest == null
          ? null
          : _serializers.serialize(postStatusTranslateRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    final _path = r'/api/v1/statuses/{id}/quotes/{quoting_status_id}/revoke'
        ...
        .replaceAll(
            ...
            encodeQueryParameter(
                    _serializers, quotingStatusId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
  ...
  Future<Response<Status>> updateStatus({
    ...
    try {
      ...
      _bodyData = updateStatusRequest == null
          ? null
          : _serializers.serialize(updateStatusRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<Status>> updateStatusInteractionPolicy({
    ...
    try {
      const _type = FullType(UpdateStatusInteractionPolicyRequest);
      _bodyData = updateStatusInteractionPolicyRequest == null
          ? null
          : _serializers.serialize(updateStatusInteractionPolicyRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
