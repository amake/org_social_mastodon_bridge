...
class FeaturedTagsApi {
  ...
  const FeaturedTagsApi(this._dio, this._serializers);
  ...
  Future<Response<FeaturedTag>> createFeaturedTag({
    ...
    try {
      const _type = FullType(CreateFeaturedTagRequest);
      _bodyData = _serializers.serialize(createFeaturedTagRequest,
          specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FeaturedTag),
            ) as FeaturedTag;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<BuiltList<Tag>>> getFeaturedTagSuggestions({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<FeaturedTag>>> getFeaturedTags({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
