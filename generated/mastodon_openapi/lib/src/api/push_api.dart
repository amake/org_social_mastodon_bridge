...
class PushApi {
  ...
  Future<Response<WebPushSubscription>> createPushSubscription({
    ...
    try {
      const _type = FullType(CreatePushSubscriptionRequest);
      _bodyData = _serializers.serialize(createPushSubscriptionRequest,
          specifiedType: _type);
  ...
  Future<Response<WebPushSubscription>> putPushSubscription({
    ...
    try {
      const _type = FullType(PutPushSubscriptionRequest);
      _bodyData = putPushSubscriptionRequest == null
          ? null
          : _serializers.serialize(putPushSubscriptionRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
