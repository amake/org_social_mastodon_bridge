...
class DomainBlocksApi {
  ...
  const DomainBlocksApi(this._dio, this._serializers);
  ...
  Future<Response<void>> createDomainBlock({
    ...
    try {
      const _type = FullType(CreateDomainBlockRequest);
      _bodyData = _serializers.serialize(createDomainBlockRequest,
          specifiedType: _type);
  ...
  Future<Response<void>> deleteDomainBlocks({
    ...
    try {
      const _type = FullType(DeleteDomainBlocksRequest);
      _bodyData = _serializers.serialize(deleteDomainBlocksRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<BuiltList<String>>> getDomainBlocks({
    int? limit = 100,
    String? maxId,
    String? minId,
    String? sinceId,
