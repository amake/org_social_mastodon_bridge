...
class CustomEmojisApi {
  ...
  const CustomEmojisApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CustomEmoji>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View all custom emoji Documentation](https://docs.joinmastodon.org/methods/custom_emojis/#get)
  Future<Response<BuiltList<CustomEmoji>>> getCustomEmojis({
    ...
    BuiltList<CustomEmoji>? _responseData;
    ...
    return Response<BuiltList<CustomEmoji>>(
      data: _responseData,
