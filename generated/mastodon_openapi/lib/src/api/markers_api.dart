...
class MarkersApi {
  ...
  const MarkersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltMap<String, Marker>] as data
  ...
  Future<Response<BuiltMap<String, Marker>>> createMarker({
    ...
    try {
      const _type = FullType(CreateMarkerRequest);
      _bodyData = createMarkerRequest == null
          ? null
          : _serializers.serialize(createMarkerRequest, specifiedType: _type);
    ...
    BuiltMap<String, Marker>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltMap, [FullType(String), FullType(Marker)]),
            ) as BuiltMap<String, Marker>;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<BuiltMap<String, Marker>>(
      data: _responseData,
  ...
  Future<Response<BuiltMap<String, Marker>>> getMarkers({
    BuiltList<FilterContextEnum>? timeline,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _queryParameters = <String, dynamic>{
      if (timeline != null)
        r'timeline': encodeCollectionQueryParameter<FilterContextEnum>(
          _serializers,
          timeline,
