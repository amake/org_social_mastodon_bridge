...
class ConversationsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Conversation>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View all conversations Documentation](https://docs.joinmastodon.org/methods/conversations/#get)
  Future<Response<BuiltList<Conversation>>> getConversations({
    int? limit = 20,
    String? maxId,
    String? minId,
    String? sinceId,
    ...
    BuiltList<Conversation>? _responseData;
    ...
    return Response<BuiltList<Conversation>>(
      data: _responseData,
