...
class TrendsApi {
  ...
  const TrendsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TrendsLink>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View trending links Documentation](https://docs.joinmastodon.org/methods/trends/#links)
  Future<Response<BuiltList<TrendsLink>>> getTrendLinks({
    int? limit = 10,
    int? offset,
    ...
    BuiltList<TrendsLink>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(TrendsLink)]),
            ) as BuiltList<TrendsLink>;
    ...
    return Response<BuiltList<TrendsLink>>(
      data: _responseData,
  ...
  Future<Response<BuiltList<Status>>> getTrendStatuses({
    int? limit = 20,
    int? offset,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  Future<Response<BuiltList<Tag>>> getTrendTags({
    int? limit = 10,
    int? offset,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
