...
class ListsApi {
  ...
  Future<Response<BuiltList>> createList({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createListRequest, specifiedType: _type);
  ...
  Future<Response<void>> deleteListAccounts({
    ...
    try {
      const _type = FullType(DeleteListAccountsRequest);
      _bodyData = _serializers.serialize(deleteListAccountsRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<BuiltList<Account>>> getListAccounts({
    required String id,
    int? limit = 40,
    String? maxId,
    String? minId,
  ...
  Future<Response<BuiltList<BuiltList>>> getLists({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> postListAccounts({
    ...
    try {
      const _type = FullType(PostListAccountsRequest);
      _bodyData =
          _serializers.serialize(postListAccountsRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<BuiltList>> updateList({
    required String id,
    required CreateListRequest createListRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
