...
class AccountsApi {
  ...
  Future<Response<Token>> createAccount({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createAccountRequest, specifiedType: _type);
  ...
  Future<Response<BuiltList<Account>>> getAccountEndorsements({
    required String id,
    int? limit = 40,
    String? maxId,
    String? sinceId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FeaturedTag>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Get account&#39;s featured tags Documentation](https://docs.joinmastodon.org/methods/accounts/#featured_tags)
  Future<Response<BuiltList<FeaturedTag>>> getAccountFeaturedTags({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<FeaturedTag>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(FeaturedTag)]),
            ) as BuiltList<FeaturedTag>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<FeaturedTag>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<Account>>> getAccountFollowers({
    required String id,
    int? limit = 40,
    String? maxId,
    String? minId,
  ...
  Future<Response<BuiltList<Account>>> getAccountFollowing({
    required String id,
    int? limit = 40,
    String? maxId,
    String? minId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<IdentityProof>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Identity proofs Documentation](https://docs.joinmastodon.org/methods/accounts/#identity_proofs)
  @Deprecated('This operation has been deprecated')
  Future<Response<BuiltList<IdentityProof>>> getAccountIdentityProofs({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<IdentityProof>? _responseData;
    ...
    return Response<BuiltList<IdentityProof>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<BuiltList>>> getAccountLists({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<BuiltList>? _responseData;
    ...
    return Response<BuiltList<BuiltList>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Account>> getAccountLookup({
    ...
    final _queryParameters = <String, dynamic>{
      r'acct': encodeQueryParameter(_serializers, acct, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Relationship>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Check relationships to other accounts Documentation](https://docs.joinmastodon.org/methods/accounts/#relationships)
  Future<Response<BuiltList<Relationship>>> getAccountRelationships({
    BuiltList<String>? id,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (withSuspended != null)
        r'with_suspended': encodeQueryParameter(
            _serializers, withSuspended, const FullType(bool)),
    };
    ...
    BuiltList<Relationship>? _responseData;
    ...
    return Response<BuiltList<Relationship>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<Account>>> getAccountSearch({
    required String q,
  ...
  Future<Response<BuiltList<Status>>> getAccountStatuses({
    required String id,
    bool? excludeReblogs,
    bool? excludeReplies,
    int? limit = 20,
    ...
    final _queryParameters = <String, dynamic>{
      if (excludeReblogs != null)
        r'exclude_reblogs': encodeQueryParameter(
            _serializers, excludeReblogs, const FullType(bool)),
      if (excludeReplies != null)
        r'exclude_replies': encodeQueryParameter(
            _serializers, excludeReplies, const FullType(bool)),
      if (limit != null)
        r'limit':
            encodeQueryParameter(_serializers, limit, const FullType(int)),
      if (maxId != null)
      ...
      if (pinned != null)
        r'pinned':
            encodeQueryParameter(_serializers, pinned, const FullType(bool)),
      if (sinceId != null)
        r'since_id':
            encodeQueryParameter(_serializers, sinceId, const FullType(String)),
      if (tagged != null)
        r'tagged':
            encodeQueryParameter(_serializers, tagged, const FullType(String)),
    };
  ...
  Future<Response<BuiltList<Account>>> getAccounts({
    BuiltList<String>? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FamiliarFollowers>] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Find familiar followers Documentation](https://docs.joinmastodon.org/methods/accounts/#familiar_followers)
  Future<Response<BuiltList<FamiliarFollowers>>> getAccountsFamiliarFollowers({
    BuiltList<String>? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<FamiliarFollowers>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<FamiliarFollowers>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<FamiliarFollowers>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CredentialAccount>> getAccountsVerifyCredentials({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CredentialAccount),
  ...
  Future<Response<CredentialAccount>> patchAccountsUpdateCredentials({
    ...
    try {
      const _type = FullType(PatchAccountsUpdateCredentialsRequest);
      _bodyData = patchAccountsUpdateCredentialsRequest == null
          ? null
          : _serializers.serialize(patchAccountsUpdateCredentialsRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<Relationship>> postAccountFollow({
    ...
    try {
      const _type = FullType(PostAccountFollowRequest);
      _bodyData = postAccountFollowRequest == null
          ? null
          : _serializers.serialize(postAccountFollowRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<Relationship>> postAccountMute({
    ...
    try {
      const _type = FullType(PostAccountMuteRequest);
      _bodyData = postAccountMuteRequest == null
          ? null
          : _serializers.serialize(postAccountMuteRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<Relationship>> postAccountNote({
    ...
    try {
      const _type = FullType(PostAccountNoteRequest);
      _bodyData = postAccountNoteRequest == null
          ? null
          : _serializers.serialize(postAccountNoteRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
